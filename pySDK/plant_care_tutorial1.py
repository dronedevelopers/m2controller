...
if bUseCallBack:
    controller = m2controller.BleCtrller(m2Const.etDebian,callbackfunc,usrCfg.BleMACaddress) # 配置使用回调函数
else:
    controller = m2controller.BleCtrller(m2Const.etDebian,,None,usrCfg.BleMACaddress)
