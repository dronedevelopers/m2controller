...
########################################################################################
controller = m2controller.BleCtrller(m2Const.etInternet,None,None,0,usrCfg.InternetHostIPaddr,usrCfg.mqttPort,usrCfg.mqttusername,usrCfg.mqttpassword)
controller.connect()
time.sleep(1)
...
########################################################################################
controller.show_LEDmatrixFrame(
