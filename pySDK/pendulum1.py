...
################################################################
# initialize the controller, remember to set the field BleMACaddress to be your device's MAC address
################################################################
# TODO: let's initialize the BleMACaddress if not being set by user.
controller = m2controller.BleCtrller(m2Const.etDebian,callbackfunc,usrCfg.BleMACaddress)
controller.connect()
